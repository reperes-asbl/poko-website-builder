...
{% link url="reperes@reperes.be", linkType="email" %}
...
{% sectionTwoColumns class="palette-cooper palette-low-contrast bleed-bg" %}
...
{% link url="https://www.google.com/maps/place/Bd+de+Waterloo+99,+1000+Bruxelles/", text="Boulevard de Waterloo 99, 1000 Bruxelles", linkType="external" %}
