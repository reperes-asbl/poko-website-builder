...
{% wrapper tag="section", class="reset-down-w palette-delft-blue-contrast bleed-bg v--bleed-bottom:40rem v--width-fluid-min:60%" %}
## Un peu d’histoire
...
{% wrapper tag="section", class="squash-section prose box palette-cooper border-5" %}
...
{% wrapper tag="section", class="palette-ylnMn-blue-contrast bleed-bg v--bleed-top:25rem" %}
